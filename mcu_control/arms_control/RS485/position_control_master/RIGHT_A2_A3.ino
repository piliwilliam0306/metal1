...
void RIGHT_A2_A3()
{
  ...
  if(abs(cmd_Axis_0-right_angle_Axis_2)>0.01)
  {
    if((right_angle_Axis_2-cmd_Axis_0)>0){
  ...
  if(abs(cmd_Axis_1_by_1-right_angle_Axis_3)>0.01)
  {
    if((right_angle_Axis_3-cmd_Axis_1_by_1)>0){
    ...
    //cmd_Motor_0
    cmd_Motor_R2= cmd_Motor_R2 + cmd_Motor_0_increment_by_0;
    //cmd_Axis_0
    cmd_Axis_0=(double)cmd_Motor_R2/gearRatio_Axis_0;
    ...
    cmd_Motor_R3=cmd_Motor_1_by_0+cmd_Motor_1_by_1;
    //cmd_Axis_1
