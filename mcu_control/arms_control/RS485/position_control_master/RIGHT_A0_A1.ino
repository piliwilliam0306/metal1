...
void RIGHT_A0_A1()
{
  ...
  if(abs(cmd_Axis_0-right_angle_Axis_0)>0.01)
  {
    if((right_angle_Axis_0-cmd_Axis_0)>0){
  ...
  if(abs(cmd_Axis_1_by_1-right_angle_Axis_1)>0.01)
  {
    if((right_angle_Axis_1-cmd_Axis_1_by_1)>0){
    ...
    //cmd_Motor_0
    cmd_Motor_R0= cmd_Motor_R0 + cmd_Motor_0_increment_by_0;
    //cmd_Axis_0
    cmd_Axis_0=(double)cmd_Motor_R0/gearRatio_Axis_0;
    ...
    cmd_Motor_R1=cmd_Motor_1_by_0+cmd_Motor_1_by_1;
    //cmd_Axis_1
