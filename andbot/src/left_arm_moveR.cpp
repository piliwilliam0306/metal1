  ...
  MoveR::MoveR()
{
  ...
  arm_angle.joint0.angle = 0.0;
  arm_angle.joint0.duration = 0.0;
  arm_angle.joint1.angle = 0.0;
  arm_angle.joint1.duration = 0.0;
  arm_angle.joint2.angle = 0.0;
  arm_angle.joint2.duration = 0.0;
  arm_angle.joint3.angle = 0.0;
  arm_angle.joint3.duration = 0.0;

  Target.x.data=0.0,Target.y.data=0.0,Target.z.data=0.0;
  if(LEFT_ARM){
    axis_pub = nh_.advertise<andbot::JointCmd>("andbot/joint/L/cmd/position", 1);
    goal_sub = nh_.subscribe("/andbot/left_arm/goal", 1000, &MoveR::goalCallback,this);
  }
  if(RIGHT_ARM){
    axis_pub = nh_.advertise<andbot::JointCmd>("andbot/joint/R/cmd/position", 1);
