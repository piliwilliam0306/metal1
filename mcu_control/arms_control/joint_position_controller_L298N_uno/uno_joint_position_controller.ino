/*
  file: uno_joint_position.cpp
  date: 20160218
  description :
 
        this version is for demo 
	CCW for L1 R0 R1 is right!!
        
	this version is for uno and L298N

	#define MotorPin0 9 //uno
	#define MotorPin1 10 //uno
