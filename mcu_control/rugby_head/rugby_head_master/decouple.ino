...
void LEFT_A0_A1()
{
  ...
  */
  ...
  if(abs(cmd_Axis_0-pan_angle_Axis)>0.01)
  {
    if((pan_angle_Axis-cmd_Axis_0)>0){
  ...
  if(abs(cmd_Axis_1_by_1-tilt_angle_Axis)>0.01)
  {
    if((tilt_angle_Axis-cmd_Axis_1_by_1)>0){
    ...
    //cmd_Motor_0
    cmd_Motor_P= cmd_Motor_P + cmd_Motor_0_increment_by_0;
    //cmd_Axis_0
    cmd_Axis_0=(double)cmd_Motor_P/gearRatio_Axis_0;
    ...
    cmd_Motor_T=cmd_Motor_1_by_0+cmd_Motor_1_by_1;
    //cmd_Axis_1
